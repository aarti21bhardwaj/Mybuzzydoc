            ...
            <div class="ibox-content">
              <?= $this->Form->create($surveyQuestion, [ 'data-toggle'=>"validator", 'class' => 'form-horizontal']) ?>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?= $this->Form->input('survey_id', ['label' => false, 'required' => true, 'class' => ['form-control'], 'options' => $surveys ]); ?>
                            </div>
                    </div>
                    <?= $this->Inspinia->horizontalRule(); ?>
                    <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?= $this->Form->input('question_id', ['label' => false, 'required' => true, 'class' => ['form-control'], 'options' => $questions]); ?>
                            </div>
                    </div>
                    <?= $this->Inspinia->horizontalRule(); ?>
                        <div class="form-group">
