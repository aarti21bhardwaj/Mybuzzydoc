            ...
            <div class="ibox-content">
                ...
                <form data-toggle="validator" name="referralSetting" class="form-horizontal" ng-submit="Settings.submitForm()">
                    ...
                    <div class="form-group">
                        <label name="levelName" class="col-sm-2 control-label" >Referral Level Name</label>
                    ...
                    <div class="form-group">
                         ...
                         <label class="col-sm-2 control-label" name="referrerAwardPoints" data-toggle="tooltip" data-placement="top" title="Points awarded to a patient for making a referral." data-original-title="Tooltip on top"> <i class="fa- fa fa-info-circle" style="padding-right: 5px"></i>Referrer Award Points</label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label" name="referreeAwardPoints" data-toggle="tooltip" data-placement="top" title="Points awarded to the referred patient when they start treatment with your practice." data-original-title="Tooltip on top"> <i class="fa- fa fa-info-circle" style="padding-right: 5px"></i>Referree Award Points</label>
                    ...
                    <div class="form-group">
                        ...
                        <label name="gift_coupon" class="col-sm-2 control-label"> Referree Gift Coupon</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            <button class="btn-primary btn" ng-disabled = "referralSetting.$invalid">Submit</button>
...
<?php
    ...
    echo 'var vendorReferralSettingId = "'.$vendorReferralSettingId.'";';
?>
</script>