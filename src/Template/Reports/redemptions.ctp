                    ...
                    <tbody>
                        <?php 
                            ...
                            <tr>
                                ...
                                <td><?= (isset($value->service))?h($value->service->label):'' ?></td>
                                <td><?= ($value->amount)?h($value->amount):h($value->points) ?></td>
    ...
    $(document).ready(function(){
        ...
        $('.dataTables').DataTable({
            ...
            buttons: [
                { extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Redemption Report'},
                {extend: 'pdf', title: 'Redemption Report'},
