    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><?= __('Edit Email Settings') ?></h5>
            </div>
            <div class="ibox-content">
                <?= $this->Form->create($emailSetting, ['class'=>'form-horizontal']) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?= $this->Form->input('body', ['type'=>'textarea', 'id' =>'tinymceTextarea','required'=> true,'label' => false, 'class' => ['form-control']]); ?>
                    </div>
                </div>
                <?= $this->Inspinia->horizontalRule(); ?>
                <div class="form-group">
