<?= $this->Html->script(['tours/referralTier-tour']) ?>

<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5 id = 'addReferralTier'><?= __('Add Referral Tier') ?></h5>
            ...
            <div class="ibox-content">
                ...
                <?php } ?>
                <div class="form-group">
                    <?= $this->Form->label('name', __('Name'), ['class' => ['col-sm-2', 'control-label'], 'id' => 'referralTierName']); ?>
                    <div class="col-sm-10">
                ...
                <?= $this->Inspinia->horizontalRule(); ?>
                <div class="form-group">
                    <?= $this->Form->label('referrals_required', __('Referrals Required'), ['class' => ['col-sm-2', 'control-label'], 'id' => 'requiredReferral']); ?>
                    <div class="col-sm-10">
                ...
                <?= $this->Inspinia->horizontalRule(); ?>
                <div class="form-group">
                    <?= $this->Form->label('points', __('Points'), ['class' => ['col-sm-2', 'control-label'], 'id' => 'points']); ?>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-2">
                        <?= $this->Form->button(__('Submit'), ['class' => ['btn', 'btn-primary'], 'id' => 'saveReferraltier']) ?>
